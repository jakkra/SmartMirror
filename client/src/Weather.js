...
export default class Weather extends React.Component {
  ...
  render() {
  	...
  	if(this.state.weather.windDirection){
	  	windDirectionSymbol = (<img style={{marginTop: 20, marginLeft: 50, width: 90, height: 90, WebkitTransform: 'rotate(' + this.state.weather.windDirection + 'deg)'}} role="presentation" src={require('../resources/weather-icons/wind_arrow.png')}/>);
  	} else {
