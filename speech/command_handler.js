module.exports = mirrorSocket => {
  ...
  const skanetrafiken = require('../util/skanetrafiken');
    ...
    handle: function(command) {
      ...
      switch (commandId) {
        ...
        case SpeechCommand.SHOW_NEWS:
          mirrorSocket.sendToClient('visibility', {
            component: 'news',
            visible: true,
          });
          break;
        ...
        case SpeechCommand.NEXT_ARTICLE:
          mirrorSocket.sendToClient('command', {
            component: 'article',
            action: 'next',
          });
          break;
        ...
        case SpeechCommand.TURN_OFF_EVERYTHING:
          ...
          serialHandler.turnOffLedstrip();
          serialHandler.setOutletOff([2, 3, 4]);
          break;
